...
static const Key keys[] = {
    ...
    // rofi
    { MODKEY|ControlMask, XK_m, spawn, SHCMD("rofi -show-icons -show drun -theme gruvbox-dark") },
    { MODKEY, XK_m, spawn, SHCMD("rofi -show-icons -show window -theme gruvbox-dark") },
    ...
    // Browser
    { MODKEY, XK_c, spawn, SHCMD("/usr/bin/google-chrome-stable --profile-directory='Profile 2'") },

    // Slack
    { MODKEY, XK_s, spawn, SHCMD("slack") },

    // Notion 
    { MODKEY, XK_n, spawn, SHCMD("notion-app") },
